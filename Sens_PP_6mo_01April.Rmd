---
title: "Sensitivity analysis for Per Protocol with 6-month washout"
...
```{r}
df <- readRDS("statin_clean_6m.rds")
...
png("PP_surv_curve_6m.png", units="in", width = 9, height = 6, res = 500)
surv_plot_PP
dev.off()
```
