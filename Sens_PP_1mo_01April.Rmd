---
title: "Sensitivity analysis for Per Protocol with 1-month washout"
...
```{r}
df <- readRDS("statin_clean_1m.rds")
...
wt_adj_plr_PP <- glm(ICH ~ visit_month + visit_month2 + statin_yn_b + 
...
png("PP_surv_curve_1m.png", units="in", width = 9, height = 6, res = 500)
surv_plot_PP
dev.off()
```
